            ...
            <div class="widget am-cf">
                <div class="widget-body  am-margin-bottom-lg">
                    <div class="am-u-sm-12">
                        ...
                        $detail['pt_status']['value'] === 30 && $progress += 1;
                        ...
                        <ul class="order-detail-progress progress-<?= $progress ?>">
                            ...
                            <li>
                                <span>拼团</span>
                                <?php if ($detail['pt_status']['value'] === 30): ?>
                                    <div class="tip">
                                        成团于 <?= date('Y-m-d H:i:s', $detail['pt_time']) ?>
                                    </div>
                                <?php endif; ?>
                            </li>
                            <li>
                    ...
                    <?php if ($detail['pay_status']['value'] === 20 && $detail['pt_status']['value'] === 30): ?>
                    <div class="widget-head am-cf">
                        <div class="widget-title am-fl">发货信息</div>
                    </div>

                    <?php if ($detail['delivery_status']['value'] === 10 &&$detail['pt_status']['value'] === 30): ?>
                    <!-- 去发货 -->
                    <form id="delivery" class="my-form am-form tpl-form-line-form" method="post"
                          action="<?= url('plugins.pt.order/delivery', ['order_id' => $detail['pt_order_id']]) ?>">
