                                    ...
                                    <tr>
                                        ...
                                        <?php if ($i === 1) : $goodsCount = count($order['goods']); ?>
                                            ...
                                            <td class="am-text-middle" rowspan="<?= $goodsCount ?>">
                                                ...
                                                <p>拼团状态：
                                                    <span class="am-badge
                                                <?= $order['pt_status']['value'] === 20 ? 'am-badge-secondary' : ($order['pt_status']['value'] === 30 ? 'am-badge-success' : '') ?>">
                                                        <?= $order['pt_status']['text'] ?></span>
                                                </p>
                                                <p>发货状态：
                                                    <span class="am-badge
                                            ...
                                            <td class="am-text-middle" rowspan="<?= $goodsCount ?>">
                                                <div class="tpl-table-black-operation">
                                                    <a class="tpl-table-black-operation-green"
                                                       href="<?= url('plugins.pt.order/detail', ['order_id' => $order['pt_order_id']]) ?>">
                                                        订单详情</a>
                                                    <?php if ($order['pay_status']['value'] === 20
                                                        && $order['delivery_status']['value'] === 10 && $order['pt_status']['value'] === 30): ?>
                                                        <a class="tpl-table-black-operation"
                                                           href="<?= url('plugins.pt.order/detail#delivery',
                                                               ['order_id' => $order['pt_order_id']]) ?>">
                                                            去发货</a>
                                                    <?php endif; ?>
                                                </div>
                                            </td>
