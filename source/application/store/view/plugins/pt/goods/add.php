                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">拼团商品名称 </label>
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">拼团商品分类 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <select name="goods[pt_category_id]" required
                                            data-am-selected="{searchBox: 1, btnSize: 'sm',  placeholder:'请选择拼团商品分类'}">
                                        <option value=""></option>
                                        <?php if (isset($catgory)): foreach ($catgory as $first): ?>
                                            <option value="<?= $first['pt_category_id'] ?>"><?= $first['name'] ?></option>
                                            <?php if (isset($first['child'])): foreach ($first['child'] as $two): ?>
                                                <option value="<?= $two['pt_category_id'] ?>">
                                                    　　<?= $two['name'] ?></option>
                                                <?php if (isset($two['child'])): foreach ($two['child'] as $three): ?>
                                                    <option value="<?= $three['pt_category_id'] ?>">
                                                        　　　<?= $three['name'] ?></option>
                                    ...
                                    <small class="am-margin-left-xs">
                                        <a href="<?= url('plugins.pt.goods.category/add') ?>">去添加</a>
                                    </small>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">拼团商品图片 </label>
                                <div class="am-u-sm-9 am-u-end">
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">拼团商品规格 </label>
                                <div class="am-u-sm-9 am-u-end">
                                ...
                                <div class="goods-spec-box am-u-sm-9 am-u-sm-push-2 am-u-end">
                                    ...
                                    <div class="goods-sku am-scrollable-horizontal">
                                        ...
                                        <div class="spec-batch am-form-inline">
                                            ...
                                            <div class="am-form-group">
                                                <input type="number" data-type="limit_num" placeholder="购买上限">
                                            </div>
                                            <div class="am-form-group">
                            ...
                            <div class="goods-spec-single">
                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-u-lg-2 am-form-label">拼团商品编码 </label>
                                    <div class="am-u-sm-9 am-u-end">
                                ...
                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">拼团商品价格 </label>
                                    <div class="am-u-sm-9 am-u-end">
                                ...
                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-u-lg-2 am-form-label">拼团商品划线价 </label>
                                    <div class="am-u-sm-9 am-u-end">
                                ...
                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">购买上限 </label>
                                    <div class="am-u-sm-9 am-u-end">
                                        <input type="number" class="tpl-form-input" name="goods[spec][limit_num]"
                                               required>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">拼团商品重量(Kg) </label>
                                    <div class="am-u-sm-9 am-u-end">
                            ...
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">拼团商品详情</div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label">拼团商品详情 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <!-- 加载编辑器的容器 -->
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">有效成团时间 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" class="tpl-form-input" name="goods[pt_validhours]"
                                           value="" required>
                                    <small>以小时为单位,0为不限时间(不推荐)</small>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">成团人数 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" class="tpl-form-input" name="goods[pt_limit_num]"
                                           value="2" required>
                                    <small>必须大于2</small>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">拼团商品状态 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">拼团商品排序 </label>
                                <div class="am-u-sm-9 am-u-end">
...
<!-- 拼团商品多规格模板 -->
{{include file="plugins/pt/goods/_template/spec_many" /}}
        ...
        $('#my-form').superForm({
            ...
            validation: function () {
                ...
                if (specType === '20') {
                    ...
                    isEmpty === true && layer.msg('拼团商品规格不能为空');
                    return !isEmpty;
                }
                return true;
            }
