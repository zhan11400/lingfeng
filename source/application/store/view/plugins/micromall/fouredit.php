                    ...
                    <div class="widget-body">
                        <fieldset>
                            <div class="widget-head am-cf">
                                ...
                                <input type="hidden" class="tpl-form-input" name="ad[banner_id]"   value="<?= $info['banner_id'] ?>" >
                            </div>
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <div class="am-form-file">
                                        ...
                                        <div class="uploader-list am-cf">
                                            <?php if ($info['uploadFile']): ?>
                                                <div class="file-item">
                                                    <img src="<?= $info['uploadFile']['file_path'] ?>">
                                                    <input type="hidden" name="ad[image]"
                                                           value="<?= $info['uploadFile']['file_id'] ?>">
