...
class PtOrder extends OrderModel
{
     ...
     */
    public function getBuyNow($user, $goods_id, $goods_num, $goods_sku_id, $invite_info)
    {
        // 商品信息
        /* @var Goods $goods */
     ...
     * @throws \Exception
     */
    public function add($user_id, $order, $parent_id = 0)
    {
        ...
        $this->save([
            ...
            'parent_id' => $parent_id,
            'pt_limit_time' => $order['pt_limit_time'],
            'pt_limit_num' => $order['pt_limit_num']
        ]);
        // 订单商品列表
        $goodsList = [];
        // 更新商品库存 (下单减库存)
